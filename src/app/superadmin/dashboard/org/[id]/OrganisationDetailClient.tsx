...
<<<<<<< HEAD
  async function onDelete() {
    const confirm = window.confirm(
      ...
      `- All ${organisation._count.members} members associated with this organisation\n` +
      `- All ${organisation._count.elections} elections and voting data\n\n` +
    ...
    const doubleConfirm = window.confirm(
      `FINAL CONFIRMATION: Delete "${organisation.name}"?\n\n` +
      `Type "DELETE" in the next prompt to confirm.`
    );
    
    if (!doubleConfirm) return;
    
    const typedConfirm = window.prompt(`Type "DELETE" to confirm deletion of "${organisation.name}":`);
...
<<<<<<< HEAD
          ...
          <div className={styles.dangerZone}>
            <div className={styles.dangerZoneHeader}>
              ...
              <p className={styles.dangerZoneSubtitle}>Irreversible and destructive actions</p>
            </div>
